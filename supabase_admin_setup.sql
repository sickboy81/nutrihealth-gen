...
CREATE TABLE IF NOT EXISTS admin_logs (
  ...
  action_type TEXT NOT NULL, -- 'ban_user', 'unban_user', 'create_recipe', 'delete_recipe', 'export_data', etc.
...
-- 5. Políticas de segurança para admin_users
-- Admins podem ver todos os admins
...
-- Admins podem inserir novos admins
...
-- Admins podem atualizar admin users
...
-- 6. Políticas de segurança para banned_users
-- Admins podem ver todos os usuários banidos
...
-- Admins podem desbanir usuários
...
-- 7. Políticas de segurança para admin_logs
...
-- 8. Função para verificar se um usuário é admin
...
-- 9. Função para listar todos os usuários (apenas para admins)
...
-- 10. Função para banir um usuário
...
-- 11. Função para desbanir um usuário
...
-- 12. Função para adicionar um admin
...
-- 13. Função para remover um admin
...
-- 14. Função para obter estatísticas do sistema
...
-- 15. Índices para melhor performance
